...
class Blockchain:
    ...
    def register_node(self, address):
        ...
        self.nodes.add(parsed_url.netloc) # Add operation is idempotent.
    ...
    def resolve_conflicts(self):
        ...
        for node in neighbours:
            ...
            if response.status_code == 200:
                ...
                # Length is longer and chain is valid
                if length > max_length and self.valid_chain(chain):
                    max_length = length
                    new_chain = chain

        # Replace cour chain if we discovered a new, valid, longer chain
        if new_chain:
